  ...
  return <>
    <FeatureBox container={{ x: 20, y: 226 }}
      ...
      desc={<>
        ...
        <p>For more information: <a rel="noreferrer" className="text-yellow-500 hover:underline" target={"_blank"} href="https://mermaid-js.github.io/mermaid/syntax/sequenceDiagram.html">https://mermaid-js.github.io</a></p>
      </>}
    />
